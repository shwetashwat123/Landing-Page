        ...
        <div className=" flex flex-col items-center w-screen my-10 bg-white " id="">
            ...
            <div className="text-white">
                <div className="flex justify-between mx-auto w-full">
                    <div className="bg-green-500 mx-2 rounded-lg transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
                    ...
                    <div className="bg-green-300 mx-2 rounded-lg transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
                        <h3>Mentor</h3>
                    ...
                    </div><div className="bg-green-500 mx-2 rounded-lg transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
